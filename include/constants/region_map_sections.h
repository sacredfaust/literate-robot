...
#define MAPSEC_BERRY_FOREST                 0xB7
#define MAPSEC_ICEFALL_CAVE                 0xB8
#define MAPSEC_ROCKET_WAREHOUSE             0xB9
#define MAPSEC_TRAINER_TOWER_2              0xA0
#define MAPSEC_DOTTED_HOLE                  0xA1
#define MAPSEC_LOST_CAVE                    0xA2
#define MAPSEC_PATTERN_BUSH                 0xA3
#define MAPSEC_ALTERING_CAVE_FRLG           0xA4
#define MAPSEC_TANOBY_CHAMBERS              0xA5
#define MAPSEC_THREE_ISLE_PATH              0xA6
#define MAPSEC_TANOBY_KEY                   0xA7
#define MAPSEC_MONEAN_CHAMBER               0xA8
#define MAPSEC_LIPTOO_CHAMBER               0xA9
#define MAPSEC_WEEPTH_CHAMBER               0xB0
#define MAPSEC_DILFORD_CHAMBER              0xB1
#define MAPSEC_SCUFIB_CHAMBER               0xB2
#define MAPSEC_RIXY_CHAMBER                 0xB3
#define MAPSEC_VIAPOIS_CHAMBER              0xB4
#define MAPSEC_EMBER_SPA                    0xB5
#define MAPSEC_SPECIAL_AREA                 0xB6
#define MAPSEC_AQUA_HIDEOUT                 0xB7
#define MAPSEC_MAGMA_HIDEOUT                0xB8
#define MAPSEC_MIRAGE_TOWER                 0xB9
#define MAPSEC_BIRTH_ISLAND                 0xBA
#define MAPSEC_FARAWAY_ISLAND               0xBB
#define MAPSEC_ARTISAN_CAVE                 0xBC
#define MAPSEC_MARINE_CAVE                  0xBD
#define MAPSEC_UNDERWATER_MARINE_CAVE       0xBE
#define MAPSEC_TERRA_CAVE                   0xBF
#define MAPSEC_UNDERWATER_105               0xC0
#define MAPSEC_UNDERWATER_125               0xC1
#define MAPSEC_UNDERWATER_129               0xC2
#define MAPSEC_DESERT_UNDERPASS             0xC3
#define MAPSEC_ALTERING_CAVE                0xC4
#define MAPSEC_NAVEL_ROCK                   0xC5
#define MAPSEC_TRAINER_HILL                 0xC6
#define MAPSEC_NEW_BARK_TOWN                0xC7
#define MAPSEC_CHERRYGROVE_CITY             0xC8
#define MAPSEC_VIOLET_CITY                  0xC9
#define MAPSEC_AZALEA_TOWN                  0xCA
#define MAPSEC_GOLDENROD_CITY               0xCB
#define MAPSEC_ECRUTEAK_CITY                0xCC
#define MAPSEC_OLIVINE_CITY                 0xCD
#define MAPSEC_CIANWOOD_CITY                0xCE
#define MAPSEC_MAHOGANY_TOWN                0xCF
#define MAPSEC_BLACKTHORN_CITY              0xD0
#define MAPSEC_ROUTE_26                     0xD1
#define MAPSEC_ROUTE_27                     0xD2
#define MAPSEC_ROUTE_28                     0xD3
#define MAPSEC_ROUTE_29                     0xD4
#define MAPSEC_ROUTE_30                     0xD5
#define MAPSEC_ROUTE_31                     0xD6
#define MAPSEC_ROUTE_32                     0xD7
#define MAPSEC_ROUTE_33                     0xD8
#define MAPSEC_ROUTE_34                     0xD9
#define MAPSEC_ROUTE_35                     0xDA
#define MAPSEC_ROUTE_36                     0xDB
#define MAPSEC_ROUTE_37                     0xDC
#define MAPSEC_ROUTE_38                     0xDD
#define MAPSEC_ROUTE_39                     0xDE
#define MAPSEC_ROUTE_40                     0xDF
#define MAPSEC_ROUTE_41                     0xE0
#define MAPSEC_ROUTE_42                     0xE1
#define MAPSEC_ROUTE_43                     0xE2
#define MAPSEC_ROUTE_44                     0xE3
#define MAPSEC_ROUTE_45                     0xE4
#define MAPSEC_ROUTE_46                     0xE5
#define MAPSEC_RUINS_OF_ALPH                0xE6
#define MAPSEC_SLOWPOKE_WELL                0xE7
#define MAPSEC_UNION_CAVE                   0xE8
#define MAPSEC_ILEX_FOREST                  0xE9
#define MAPSEC_RADIO_TOWER                  0xEA
#define MAPSEC_NATIONAL_PARK                0xEB
#define MAPSEC_TIN_TOWER                    0xEC
#define MAPSEC_BELL_TOWER                   0xED
#define MAPSEC_BURNED_TOWER                 0xEE
#define MAPSEC_SPROUT_TOWER                 0xEF
#define MAPSEC_WHIRL_ISLANDS                0xF0
#define MAPSEC_DARK_CAVE                    0xF1
#define MAPSEC_MT_MORTAR                    0xF2
#define MAPSEC_ICE_PATH                     0xF3
#define MAPSEC_LAKE_OF_RAGE                 0xF4
